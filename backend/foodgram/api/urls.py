...
from .views import (
    ...
    FavoriteViewSet, SubscriptionListView, SubscriptionView, ShoppingCartViewSet,
...
router_v1.register(r'recipes/(?P<recipe_pk>\d+)/shopping_cart', ShoppingCartViewSet,basename='shopping_cart')

urlpatterns = [
    path('recipes/download_shopping_cart/', ShoppingCartListView.as_view(), name='shopping_cart-list'),
